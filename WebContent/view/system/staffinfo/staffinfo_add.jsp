...
<form action="${pageContext.request.contextPath }/StaffInfoController/staffinfoAdd.action" class="form-horizontal"  method="post">
   	<div class="row">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text"  name="staffId" class="form-control input-sm" placeholder="请输入编号" readonly="readonly"/>
                </div>
            </div>
