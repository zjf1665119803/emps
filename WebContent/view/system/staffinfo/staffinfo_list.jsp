...
<div class="row" style="padding:15px; padding-top:0px; ">
	<table class="table  table-condensed table-striped">
        ...
        <tr>
            ...
            <td>
            	<a  href="${pageContext.request.contextPath }/StaffInfoController/staffinfoUpdateUi.action?staffId=${staffInfo.staffId }">修改</a>
...
<script type="text/javascript">
   ...
   function findByMethod() {
	 ...
	 if(method == "byName"){
		 location.href="${pageContext.request.contextPath }/StaffInfoController/findByMethod.action?staffName="+methodValue;
	 }else if(method == "byGender"){
		 location.href="${pageContext.request.contextPath }/StaffInfoController/findByMethod.action?staffSex="+methodValue;
	 }
