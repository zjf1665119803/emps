...
<form action="${pageContext.request.contextPath }/ClassController/addClass.action" method="post" class="form-horizontal">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="classId" class="form-control input-sm" readonly="readonly" placeholder="请输入编号"/>
                </div>
            </div>
   	...
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-4">
        	<input  type="submit" class="btn btn-success" value="保存"/>
              ...
              <a class="btn btn-warning" href="${pageContext.request.contextPath }/view/classinfo/classinfo/classinfo_list.jsp">返回上一级</a>
        </div>
    </div>
</form>
