...
<div class="row alert alert-info"  style="margin:0px; padding:3px;" >
     ...
     <div class="form-group">
        ...
        <input type="text" class="form-control input-sm" id="classNameId" placeholder="请输入班级名称">
      </div>

    <input type="button"   class="btn btn-danger" onclick="findByName();"    value="查询"/>
    <a  class="btn btn-success"  href="${pageContext.request.contextPath }/ClassController/addBefore.action">添加班级</a>
