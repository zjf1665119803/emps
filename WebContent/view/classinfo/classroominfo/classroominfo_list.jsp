...
<div class="row alert alert-info"  style="margin:0px; padding:3px;" >
     ...
     <div class="form-group">
        ...
        <input type="text" class="form-control input-sm" id="classroomNameId" placeholder="请输入教室名称">
      </div>
...
<div class="row" style="padding:15px; padding-top:0px; ">
	<table class="table  table-condensed table-striped">
        ...
        <c:forEach items="${requestScope.classroomInfoList}" var ="classroomInfo">
            ...
            <th>
            <a href="${pageContext.request.contextPath }/ClassroomInfoController/updateUi.action?classroomId=${classroomInfo.classroomId}">修改</a> 
...
<script type="text/javascript">
	function findByName() {
		var classroomName = $("#classroomNameId").val();
		location.href="${pageContext.request.contextPath }/ClassroomInfoController/findByName.action?classroomName="+classroomName;
	}
	
	function deleteById(classroomId) {
		if(confirm("是否确定删除？")){
			location.href="${pageContext.request.contextPath }/ClassroomInfoController/deleteById.action?classroomId="+classroomId;
		}
	}
</script>
</html>
