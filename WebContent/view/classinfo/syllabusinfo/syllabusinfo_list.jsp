...
<div class="row alert alert-info"  style="margin:0px; padding:3px;" >
     ...
     <div class="form-group">
        ...
        <input type="text" class="form-control input-sm" id="syllabusNameId" placeholder="请输入课程表名称">
      </div>
...
<div class="row" style="padding:15px; padding-top:0px; ">
	<table class="table  table-condensed table-striped">
        ...
        <c:forEach items="${requestScope.syllabusInfoList}" var="syllabusInfo">
            ...
            <th>
            <a href="${pageContext.request.contextPath }/SyllabusContronller/updateUi.action?syllabusId=${syllabusInfo.syllabusId}">修改</a> 
       	...
       	<!-- <tr>
            ...
            <td>上午上课</td>
            <th>
            <a href="syllabusinfo_update.html">修改</a> 
            <a href="">删除</a>
            </th>
        </tr>   
       	<tr>
...
<script type="text/javascript">
	function findByName() {
		...
		location.href = "${pageContext.request.contextPath }/SyllabusContronller/findByName.action?syllabusName="+syllabusName;
	}
	
	function deleteById(syllabusId) {
		location.href = "${pageContext.request.contextPath }/SyllabusContronller/deleteById.action?syllabusId="+syllabusId;	
	}
</script>
</html>
