...
<form action="${pageContext.request.contextPath }/DisciplineInfoController/addDisciplineInfo.action" class="form-horizontal">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="disciplineId" class="form-control input-sm" readonly="readonly" placeholder="由数据库维护"/>
                </div>
            </div>
