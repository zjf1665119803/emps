...
<form action="${pageContext.request.contextPath }/DisciplineInfoController/update.action" class="form-horizontal">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="disciplineId" class="form-control input-sm" value="${requestScope.disciplineInfo.disciplineId}" readonly="readonly" placeholder="请输入编号"/>
                </div>
            </div>
    ...
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">描述</h5>
    	...
    	<div class="col-sm-10">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<textarea class="form-control" name="disciplineDesc">${requestScope.disciplineInfo.disciplineDesc}</textarea>
                </div>
            </div>
   	...
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-4">
        	<input  type="submit" class="btn btn-success" value="保存"/>
              ...
              <a class="btn btn-warning" href="${pageContext.request.contextPath }/view/classinfo/disciplineinfo/disciplineinfo_list.jsp">返回上一级</a>
        </div>
    </div>
</form>
