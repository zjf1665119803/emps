...
<form action="${pageContext.request.contextPath}/StudentRecruitController/studentRecruitUpdate.action" class="form-horizontal">
   	<div class="row">
	...
	<div class="row">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                	<input type="text" value="${requestScope.studentInfo.studentTellphone}" name="studentAge" class="form-control input-sm" placeholder="请输入年龄"/>
                </div>
            </div>
        </div>
    </div>
