...
<div class="row alert alert-info"  style="margin:0px; padding:3px;" >
    ...
    <a  class="btn btn-success"  href="${pageContext.request.contextPath}/view/recruitstudent/recruitstudent/recruitstudent_add.jsp">添加学员</a>
...
<div class="row" style="padding:15px; padding-top:0px; ">
	<table class="table  table-condensed table-striped">
        ...
        <c:forEach items="${requestScope.studentInfoList}" var ="studentInfo">
            ...
            <th>
            <a href="${pageContext.request.contextPath}/StudentRecruitController/studentRecruitUpdateUi.action?studentId=${studentInfo.studentId}">修改</a> 
...
function deleteById(id){
	if(confirm("是否删除？")){
		location.href="${pageContext.request.contextPath}/StudentRecruitController/studentRecruitDelete.action?studentId="+id;
	}else{}
}
function find(){
	...
	location.href="${pageContext.request.contextPath}/StudentRecruitController/studentFindBy.action?studentName="+name+"&studentType="+type;
