...
<form action="${pageContext.request.contextPath}/StudentInfoController/studentInfoUpdate.action" class="form-horizontal">
   	<div class="row">
    	<div class="col-sm-3 col-sm-offset-4">
        	<input  type="submit" class="btn btn-success" value="修改"/>
            <a class="btn btn-warning" href="${pageContext.request.contextPath}/StudentInfoController/findAllStudent.action">返回上一级</a>
        </div>
    </div>
	...
	<div class="row">
        	...
        	<div class="form-group">
                ...
                <div class="col-sm-4">
                	<select  name="studentSex" class="form-control input-sm" >
                    	<c:if test="${requestScope.studentInfo.studentSex == '男'}">
                    	<option selected value="男">男</option>
                        <option value="女">女</option>
                    	</c:if>
                    	<c:if test="${requestScope.studentInfo.studentSex == '女'}">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                	<input type="text" value="${requestScope.studentInfo.studentAge}" name="studentAge" class="form-control input-sm" placeholder="请输入年龄"/>
                </div>
            </div>
        </div>
    </div>
   <!--结束 -->
    	...
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" value="${requestScope.studentInfo.studentTellphone}" name="studentTellphone" class="form-control input-sm" placeholder="请输入手机号码"/>
                </div>
            </div>
        </div>
        <div class="col-sm-5">
