...
<form action="${pageContext.request.contextPath}/StudentInfoController/studentInfoAdd.action" class="form-horizontal">
   	<div class="row">
    	...
    	<div class="col-sm-10">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	...
                	${requestScope.studentInfo.studentDesc}</textarea>
                </div>
            </div>
