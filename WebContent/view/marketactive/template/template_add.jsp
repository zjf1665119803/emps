...
<form action="${pageContext.request.contextPath }/TemplateController/addTemplate.action" class="form-horizontal" method="post">
        	...
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<select name="templateType" class="form-control input-sm">
                    	<option value="短信模板" selected="selected">短信模板</option>
