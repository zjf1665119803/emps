		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a
						href="${pageContext.request.contextPath }/bootm.html" target="mainframe">
							<i class="icon-dashboard"></i> <span class="menu-text">
								控制台 </span>
					</a></li>
                 <c:forEach items="${requestScope.dtoList }" var="dtoInfo">
                      <li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text"> ${dtoInfo.anth.anthortyName }</span> <b class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
						   <c:forEach items="${dtoInfo.list }" var="childInfo">
						     <li><a href="${pageContext.request.contextPath }${childInfo.anthortyUrl}" target="mainframe"> <i
									class="icon-double-angle-right"></i> ${childInfo.anthortyName}
							</a></li>
						   </c:forEach>
							
                            <!-- <li><a href="./StaffInfoController/findAllStaff.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 员工管理
							</a></li>
                            <li><a href="./RoleController/listRole.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 角色管理
							</a></li>
						   <li><a href="./RoleController/findRoleUserList.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 角色变更	</a></li>
                          <li><a href="./AnthortyController/listAnthorty.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 权限管理	</a></li> 
                         <li><a href="./AnthortyController/authortyChangeList.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 权限变更</a></li>  
   						 <li><a href="./DataDictionaryController/findByType.action" target="mainframe"> <i
			  ...
			  <!-- <li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
                            ...
                            <li><a href="./TemplateController/listTemplate.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 模板管理
							</a></li>
                             <li><a href="./MessafeController/listMessafe.action" target="mainframe"> <i
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="${pageContext.request.contextPath }/bootm.html"
